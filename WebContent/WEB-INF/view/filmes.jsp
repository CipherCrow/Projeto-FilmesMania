...
<body class="bg-dark">
    ...
    <div class="header-container">
        <div class="container">
            <header class="d-flex align-items-center justify-content-around text-center text-white flex-sm-row header-principal">
                <div class="logo">
    ...
    <main class="container text-center">
        <section class="row justify-content-evenly" id="filmes">
